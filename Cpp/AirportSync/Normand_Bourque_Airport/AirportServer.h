...
class AirportServer
{
  ...
  private:
	...
	*/
	...
	static mutex runwayFourL;
	static mutex runwayFourR;
	static mutex runwayNine;
	static mutex runwayFourteen;
	static mutex runwayFifteenL;
	static mutex runwayFifteenR;

	condition_variable conditionVarable;
	bool ready = false;
	/**
