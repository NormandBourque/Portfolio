...
char bit_string[43], sign_bit[1], exponent_string[9],mantissa_string[28];
int i,j,k;
...
bit_string[42] = '\0';
for(int numberOfTimes = 1;numberOfTimes < 11;numberOfTimes++)
	{
	printf("please enter a floating point number and new-line: ");
	scanf("%g", &float_32.floating_value_in_32_bits);

	//bit. is stored as little indiean swapping for big
	bit_string[0] = float_32.bit.b31?'1':'0';
	sign_bit[0] = bit_string[0];
	sign_bit[1] = '\0';

	bit_string[2] = float_32.bit.b30?'1':'0';
	exponent_string[0] = bit_string[2];
	bit_string[3] = float_32.bit.b29?'1':'0';
	exponent_string[1] = bit_string[3];
	bit_string[4] = float_32.bit.b28?'1':'0';
	exponent_string[2] = bit_string[4];
	bit_string[5] = float_32.bit.b27?'1':'0';
	exponent_string[3] = bit_string[5];
	exponent_string[4] = ' ';

	bit_string[7] = float_32.bit.b26?'1':'0';
	exponent_string[5] = bit_string[7];
	bit_string[8] = float_32.bit.b25?'1':'0';
	exponent_string[6] = bit_string[8];
	bit_string[9] = float_32.bit.b24?'1':'0';
	exponent_string[7] = bit_string[9];
	bit_string[10] = float_32.bit.b23?'1':'0';
	exponent_string[8] = bit_string[10];
	exponent_string[9] = '\0';

	//start of mantissa hidden 1 before this point
	bit_string[12] = float_32.bit.b22?'1':'0';
	mantissa_string[0] = bit_string[12];
	bit_string[13] = float_32.bit.b21?'1':'0';
	mantissa_string[1] = bit_string[13];
	bit_string[14] = float_32.bit.b20?'1':'0';
	mantissa_string[2] = bit_string[14];
	mantissa_string[3] = ' ';

	bit_string[16] = float_32.bit.b19?'1':'0';
	mantissa_string[4] = bit_string[16];
	bit_string[17] = float_32.bit.b18?'1':'0';
	mantissa_string[5] = bit_string[17];
	bit_string[18] = float_32.bit.b17?'1':'0';
	mantissa_string[6] = bit_string[18];
	bit_string[19] = float_32.bit.b16?'1':'0';
	mantissa_string[7] = bit_string[19];
	mantissa_string[8] = ' ';

	bit_string[21] = float_32.bit.b15?'1':'0';
	mantissa_string[9] = bit_string[21];
	bit_string[22] = float_32.bit.b14?'1':'0';
	mantissa_string[10] = bit_string[22];
	bit_string[23] = float_32.bit.b13?'1':'0';
	mantissa_string[11] = bit_string[23];
	bit_string[24] = float_32.bit.b12?'1':'0';
	mantissa_string[12] = bit_string[24];
	mantissa_string[13] = ' '; 

	bit_string[26] = float_32.bit.b11?'1':'0';
	mantissa_string[14] = bit_string[26];
	bit_string[27] = float_32.bit.b10?'1':'0';
	mantissa_string[15] = bit_string[27];
	bit_string[28] = float_32.bit.b9?'1':'0';
	mantissa_string[16] = bit_string[28];
	bit_string[29] = float_32.bit.b8?'1':'0';
	mantissa_string[17] = bit_string[29];
	mantissa_string[18] = ' ';

	bit_string[31] = float_32.bit.b7?'1':'0';
	mantissa_string[19] = bit_string[31];
	bit_string[32] = float_32.bit.b6?'1':'0';
	mantissa_string[20] = bit_string[32];
	bit_string[33] = float_32.bit.b5?'1':'0';
	mantissa_string[21] = bit_string[33];
	bit_string[34] = float_32.bit.b4?'1':'0';
	mantissa_string[22] = bit_string[34];
	mantissa_string[23] = ' ';

	bit_string[36] = float_32.bit.b3?'1':'0';
	mantissa_string[24] = bit_string[36];
	bit_string[37] = float_32.bit.b2?'1':'0';
	mantissa_string[25] = bit_string[37];
	bit_string[38] = float_32.bit.b1?'1':'0';
	mantissa_string[26] = bit_string[38];
	bit_string[39] = float_32.bit.b0?'1':'0';
	mantissa_string[27] = bit_string[39];
	mantissa_string[28] = '\0';


	printf("Entry: %d",numberOfTimes);
	printf("the floating value for  %15f is broken out as:\n", float_32.floating_value_in_32_bits);
	printf("mantissa:\t0x%x\tor: %s\n",float_32.f_bits.mantissa, mantissa_string);
	printf("exponent:\t0x%x\t\tor: %.5s\n",float_32.f_bits.exponent,exponent_string);
	printf("sign:\t\t%d\t\tor: %s\n",float_32.f_bits.sign,sign_bit);
	printf("in base10:\t%u\tor: %s\n",(int)float_32.floating_value_in_32_bits, bit_string);
}
