...
* Lab 2
*
* Simulates a computer operations.
*/
...
Assignment:problem set 5 6.08
Due Date: 4-2-15
Description: Simulates a computer operations.
Credit:This work is entirely my own work with some help from professor
*/

/* Testing
Ran programs from powerpoint
*/

/*Completion Statement
All requirements meet.  Learning how structs are passed around.
*/
